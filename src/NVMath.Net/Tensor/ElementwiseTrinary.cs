...
public sealed class ElementwiseTrinary : IAsyncDisposable, IDisposable
{
    ...
    private nint _descA, _descB, _descC, _descD;
        ...
        CudaStream? stream = null)
    {
        ...
        _descA = CuTensorNative.CreateTensorDescriptor(_handle, (uint)extentA.Length, extentA, null, nativeType, opA);
        _descB = CuTensorNative.CreateTensorDescriptor(_handle, (uint)extentB.Length, extentB, null, nativeType, opB);
        _descC = CuTensorNative.CreateTensorDescriptor(_handle, (uint)extentC.Length, extentC, null, nativeType, opC);
        _descD = CuTensorNative.CreateTensorDescriptor(_handle, (uint)extentD.Length, extentD, null, nativeType);

        _opDesc = CuTensorNative.CreateElementwiseTrinaryDescriptor(
            _handle,
    ...
    private void DisposeCore()
    {
        ...
        if (_opDesc != default) CuTensorNative.DestroyElementwiseTrinaryDescriptor(_opDesc);
