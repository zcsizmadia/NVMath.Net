...
public enum CuFftResult : int
{
    ...
    NotImplemented = 0xE,
    /// <summary>cuFFT license check failed.</summary>
    LicenseError   = 0x0F,
...
{
    private const string LibWindows = "cufft64_11.dll";
    private const string LibLinux   = "libcufft.so.11";
    ...
    {
        if (result == CuFftResult.Success) return;
